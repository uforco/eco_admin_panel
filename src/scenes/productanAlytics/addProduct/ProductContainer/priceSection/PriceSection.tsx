          ...
          <BercodeGenared></BercodeGenared>
            ...
            <div className=" mb-6 flex justify-between items-center gap-4 " >
                <div className=" inpurFill w-full ">
                    ...
                    <input type="number" id="qty" value={data?.product?.qty} onChange={(e)=> dispatch(inputDataProduct({ qty: e?.target?.value }))} className=" w-full bg-gray-400 "></input>
                </div>
            ...
            <div className=" mb-6 flex justify-between items-center gap-4 " >
                <div className=" inpurFill w-full ">
                    ...
                    <input type="number" id="price" value={data?.product?.price} onChange={ (e)=> dispatch(inputDataProduct({ price: e?.target?.value })) } className=" w-full bg-gray-400 "></input>
                </div>
                <div className=" inpurFill ">
